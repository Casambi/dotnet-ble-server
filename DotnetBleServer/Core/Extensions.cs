...
namespace DotnetBleServer.Core.Extensions
{
  public static class Extensions
  {
    ...
    public static async Task<GattCharacteristicCore> GetCharacteristicAsync(this IGattService1 service, string characteristicUUID)
    {
      ...
      foreach (var characteristic in characteristics)
      {
        ...
        {
          var ch = await GattCharacteristicCore.CreateAsync(characteristic);
          return ch;
        }
      }
